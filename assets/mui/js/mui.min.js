				...
				var c = "mui-plus-pullrefresh",
					...
					k = a.Class.extend({
						...
						beginPulldown: function() {
							...
							a.plusReady(function() {
								setTimeout(function() {
									"circle" == b.options.down.style ? plus.webview.currentWebview().beginPullToRefresh() : plus.webview.currentWebview()
										.setBounce({
											offset: {
	...
	function(a, b, c) {
		...
		k.prototype.init = function() {
			...
			if (this.isDragging) {
				...
				this.lastChanged !== b && (b ? (this.handle.style.webkitTransform = "translate(" + (this.initialState ? 0 : this.handleX) +
					"px,0)", this.classList[this.initialState ? "remove" : "add"](f)) : (this.handle.style.webkitTransform =
					"translate(" + (this.initialState ? this.handleX : 0) + "px,0)", this.classList[this.initialState ? "add" :
						"remove"](f)), this.lastChanged = b)
			}
